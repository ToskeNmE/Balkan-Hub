...
lib.addCommand('group.vlasnik', 'takeinv', function(source, args)
	Inventory.Confiscate(args.target)
end, {'target:number'})

lib.addCommand('group.vlasnik', 'returninv', function(source, args)
	Inventory.Return(args.target)
end, {'target:number'})

lib.addCommand('group.vlasnik', 'clearinv', function(source, args)
	Inventory.Clear(args.target)
end, {'target:number'})

lib.addCommand('group.vlasnik', 'saveinv', function(source, args)
	saveInventories(args[1] == 1 or args[1] == 'true')
end)

lib.addCommand('group.vlasnik', 'viewinv', function(source, args)
