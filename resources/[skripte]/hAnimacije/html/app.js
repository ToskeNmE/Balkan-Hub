...
$(document).keyup((e) => {
  if (e.key === "Escape") {
    setTimeout(() => {
      $.post("https://hAnimacije/exit", JSON.stringify({}));
    }, 300);
  }
});
...
$(function () {
  $(".fa-grin-hearts").click(function () {
    ...
    $(".expresionlista").hide();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Animacije");
  });
  ...
  $(".fa-person-carry").click(function () {
    ...
    $(".expresionlista").hide();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Objekti");
  });
  $(".fa-person-sign").click(function () {
    ...
    $(".shareddance").hide();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Plesovi");
  });
  ...
  $(".fa-walking").click(function () {
    ...
    $(".expresionlista").hide();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Stil setanja");
  });
  ...
  $(".fa-people-arrows").click(function () {
    ...
    $(".expresionlista").hide();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Animacije koje se mogu podeliti");
  });
  ...
  $(".fa-people-carry").click(function () {
    ...
    $(".expresionlista").hide();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Plesovi koji se mogu podeliti");
  });
  ...
  $(".fa-flushed").click(function () {
    ...
    $(".expresionlista").show();
    $(".aimLista").hide();
    $(".menuanimaciones h1").text("Emocije");
  });
  ...
  $(".fa-crosshairs").click(function () {
    ...
    $(".expresionlista").hide();
    $(".aimLista").show();
    $(".menuanimaciones h1").text("Tip nisana");
  });
});

window.addEventListener("load", () => {
  $.post("https://hAnimacije/callAnimations", JSON.stringify({}));
});
