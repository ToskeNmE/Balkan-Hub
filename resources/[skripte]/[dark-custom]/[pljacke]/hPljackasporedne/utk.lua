UTK = {}
UTK.timer = 300 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
UTK.hacktime = 120000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
UTK.maxcash = 250 -- maximum amount of cash a pile can hold
UTK.mincash = 500 -- minimum amount of cash a pile holds
UTK.black = true -- enable this if you want blackmoney as a reward
UTK.cooldown = 14400 -- amount of time to do the heist again in seconds (15min) 900 default  -- nu 4 UUR
UTK.mincops = 4 -- minimum required cops to start mission
UTK.vaultdoor = "hei_prop_heist_sec_door"
