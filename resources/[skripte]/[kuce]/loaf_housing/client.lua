    ...
    while in_house do
        ...
        if Vdist2(GetEntityCoords(PlayerPedId()), storage) <= 2.0 then
            ...
            if IsControlJustReleased(0, 38) and Vdist2(GetEntityCoords(PlayerPedId()), storage) <= 2.0 then
                if exports.ox_inventory:openInventory('stash', 'kuca'..tostring(OwnedHouse.houseId)) == false then
                    exports.ox_inventory:openInventory('stash', 'kuca'..tostring(OwnedHouse.houseId))
                end
            end
        end
