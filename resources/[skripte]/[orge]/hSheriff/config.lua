...
Config.sheriffStations = {
	...
	sheriff = {
		...
		Blip = {
			Coords  = vector3(1856.456, 3681.346, 34.267),
			Sprite  = 58	,
			Display = 4,
			Scale   = 0.8,
			Colour  = 5
		...
		Armories = {
			{ coords = vector3(1841.108, 3690.976, 33.267), heading = 300.55},
		},

		Vehicles = {
			{
				Spawner = { coords = vector3(1854.545, 3679.375, 32.828), heading = 160.04 },
				SpawnPoints = {
					{ coords = vector3(1853.476, 3676.384, 33.157), heading = 211.53, radius = 1.5 },
				},
			}
		},
		...
		Helicopters = {
			{
				Spawner = vector3(1868.074, 3685.622, 33.771),
				SpawnPoints = {
					{ coords = vector3(1878.919, 3677.930, 33.557), heading = 117.75, radius = 10.0 },
				}
			}
		},

		ParkirajHelikopter = {
			vector3(1878.919, 3677.930, 33.557),
		},
