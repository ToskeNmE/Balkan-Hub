...
exports.ox_inventory:RegisterStash('Sef Sheriff', 'Sef Sheriff',  50, 200000)
exports.ox_inventory:RegisterStash('Sheriff Sef', 'Sheriff Sef', 500, 200000)
exports.ox_inventory:RegisterStash('Sheriff Sef 2', 'Sheriff Sef 2', 500, 200000)
exports.ox_inventory:RegisterStash('Sheriff Sef 3', 'Sheriff Sef 3', 500, 200000)
exports.ox_inventory:RegisterStash('Sheriff Sef 4', 'Sheriff Sef 4', 500, 200000)
...
ESX.RegisterServerCallback('esx_sheriffjob:dajoruzije', function(source, cb, gun, kolicina)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer then
		if xPlayer.job.name == 'sheriff' then
...
RegisterServerEvent('esx_sheriffjob:sc')
AddEventHandler('esx_sheriffjob:sc', function(targetid, playerheading, playerCoords,  playerlocation)
    _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)

    if xPlayer.job.name == 'sheriff' then
    TriggerClientEvent('esx_sheriffjob:loose', targetid, playerheading, playerCoords, playerlocation)
    TriggerClientEvent('esx_sheriffjob:douncuffing', _source)
    end
end)
...
RegisterNetEvent('esx_sheriffjob:spawned')
...
RegisterNetEvent('esx_sheriffjob:forceBlip')
