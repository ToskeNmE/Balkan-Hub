...
Config.sudStations = {
	...
	sud = {
		...
		Blip = {
			Coords  = vector3(-1087.83, -814.888, 19.299),
			Sprite  = 58,
			Display = 4,
			Scale   = 0.75,
			Colour  = 63,
		...
		Armories = {
			vector3(212.8793, -426.058, 47.979)
		},

		Vehicles = {
			{
				Spawner = vector3(254.1614, -378.736, 44.631),
				SpawnPoints = {
					{ coords = vector3(258.0120, -377.909, 44.569), heading = 252.15, radius = 1.5 },
				},
			}
		},

		Budzenje = {
			vector3(238.5938, -370.664, 43.266),
		},
		...
		BossActions = {
			vector3(217.0940, -414.072, 47.979)
		},

		ParkirajAuto = {
			vector3(231.2209, -367.878, 43.189)
		},
