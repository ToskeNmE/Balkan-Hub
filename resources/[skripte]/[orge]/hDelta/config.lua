...
Config.deltaforceStations = {

	deltaforce = {

		Blip = {
			Coords  = vector3(1856.949, 3680.331, 33.808),
			Sprite  = 60,
			Display = 4,
			Scale   = 0.8,
			Colour  = 5
		...
		Armories = {
			{ coords = vector3(2487.873, -376.543, 81.694), heading = 224.66},
		},

		Vehicles = {
			{
				Spawner = { coords = vector3(2516.233, -454.585, 92.098), heading = 211.89 },
				SpawnPoints = {
					{ coords = vector3(2524.208, -468.850, 92.385), heading = 314.08, radius = 1.5 },
				},
			}
		},
		...
		Helicopters = {
			{
				Spawner = vector3(2499.623, -450.226, 92.992),
				SpawnPoints = {
					{ coords = vector3(2482.268, -450.335, 92.992), heading = 41.16, radius = 10.0 },
				}
			}
		},

		ParkirajHelikopter = {
			vector3(2482.268, -450.335, 92.992),
		},
