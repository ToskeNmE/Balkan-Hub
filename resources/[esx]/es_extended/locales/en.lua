Locales['en'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Dobio si platu od posla u iznosu od: ~g~$%s~s~',
  ['received_help'] = 'Dobio si socijalnu pomoc u iznosu od: ~g~$%s~s~',
  ['company_nomoney'] = 'Firma u kojoj si zaposljen nema dovoljno novca da te isplati',
  ['received_paycheck'] = 'Plata',
  ['bank'] = 'Maze Banka',
  ['account_bank'] = 'Banka',
